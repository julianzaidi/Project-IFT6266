...
def build_generator(input_var=None, nfilters=[752, 372, 128, 72, 3], filter_size=[4, 2, 2, 2, 2]):
...
def build_discriminator(input_var=None, nfilters=[72, 128, 372, 752, 100], filter_size=[2, 2, 2, 2, 4],
                        input_channels=3):
