...
def build_generator(input_var=None, nfilters=[256, 128, 72, 52, 3], filter_size=[4, 2, 2, 2, 2]):
...
def build_discriminator(input_var=None, nfilters=[52, 72, 128, 256, 100], filter_size=[2, 2, 2, 2, 4],
                        input_channels=3):
